    ...
    <main class="blog-main">
        <div class="container">
            <section class="blog-admin-guide">
                ...
                <h1>使い方</h1>
                <ol>
                    <li>左側でタイトル、本文、画像、公開日時を入力し、必要なら下書き保存します。</li>
                    <li>記事を出す時は「posts.js用をコピー」を blog/posts.js の配列へ追加します。</li>
                    <li>「記事HTMLをコピー」で生成されたHTMLを blog/スラッグ/index.html として保存します。</li>
                    <li>Gitに反映して本番デプロイ後、「公開通知メールを配信する」で購読者へ通知します。</li>
                </ol>
            </section>
            ...
            <section class="blog-editor-layout">
                <form class="blog-editor-form" data-blog-editor>
                    ...
                    <label>スラッグ<input name="slug" type="text" value="ai-mvp-first-decisions" required></label>
                    <label>カテゴリ
